...
<body>
   ...
   <form id="infor" name="infor" method="post" action="../UserServlet?action=count">
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: blue">创建新用户</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
    	  ...
    	  <div class="row">
                <div class="col-lg-3 col-md-6">
                    <label>工号：<input name="id1" id="id1" type="text" size="30"></label><br>
                     <label>初始密码：<input name="pwd" id="pwd" type="password" size="30"/></label><br>
                      <label>确认密码：<input name="pwd1" id="pwd1" type="password" size="30"/></label><br>
                           	<label>用户类型：
                    ...
                    <br>
                  				 <input type="button" value="提交"  onclick="pwd_sure()" />
                  </div>
            </div>
